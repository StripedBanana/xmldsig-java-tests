...
public class GenEnveloped {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Reference ref = fac.newReference
                ("#body", fac.newDigestMethod(DigestMethod.SHA1, null), null, null, null);

        // Reference with XPATH transform
        Transform bodyTransform = fac.newTransform(CanonicalizationMethod.XPATH,
                new XPathFilterParameterSpec("ancestor-or-self::*[local-name() = 'body']"));
        Reference refXpath = fac.newReference
                ("", fac.newDigestMethod(DigestMethod.SHA1, null), Collections.singletonList(bodyTransform), null, null);
        ...
        SignedInfo si = fac.newSignedInfo
                (fac.newCanonicalizationMethod
                        ...
                        Collections.singletonList(refXpath));
...
//        KeyPair kp = kpg.generateKeyPair();
        ...
        try (InputStream keyStoreData = new FileInputStream("C:\\Users\\Julien\\IdeaProjects\\signature-tests\\resources\\keystore")) {
        ...
        KeyStore.PrivateKeyEntry keyEntry = (KeyStore.PrivateKeyEntry) keyStore.getEntry("test", entryPassword);

        // Create a KeyValue containing the DSA PublicKey that was generated
        KeyInfoFactory kif = fac.getKeyInfoFactory();
        KeyValue kv = kif.newKeyValue(keyEntry.getCertificate().getPublicKey());
        ...
        // Get element to be signed and id it
